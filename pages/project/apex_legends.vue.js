    ...
    <section class="work-page-header">
      <div class="work-page-header__container container container--flex">
        <div class="work-page-header__client-container">
          ...
          <h3 class="work-page-header__client">${apex_legends.title}</h3>
        </div>
        ...
        <div class="work-page-header__title-container">
          ...
          <h1 class="work-page-header__title">${apex_legends.subtitle}</h1>
        </div>
        ...
        <div class="work-page-header__overview">
          ...
          >
            <div class="work-page-header__overview-content">
              <p>${apex_legends.intro}</p>

              <p>
                ${apex_legends.content}
              </p>
            </div>
          </div>
        </div>
...
for (var i = 0; i < apex_legends.nombreDeSerieDePhoto; i++) {
  template_apex_legends += `
    <div
            ...
            <figure class="image objFit">
              <picture class="image__image">
                <img
                  ...
                  srcset="
                    /assets/project/${apex_legends.folderName}/images/${
    1 + 5 * i
  }.PNG
                  "
                />
  ...
  template_apex_legends += `</div></div>`;
}

template_apex_legends += `
    </section></main></div>`;

const component_apex_legends = {
  template: template_apex_legends,
};
